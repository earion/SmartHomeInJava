...
public class LCDController {
    ...
    public static class PortExtender {
        ...
        public PortExtender(int busNumber, int address) throws IOException, I2CFactory.UnsupportedBusNumberException {
    ...
    public static void main(String args[]) throws InterruptedException,
        ...
        final PortExtender pe = new PortExtender(I2CBus.BUS_1, 0x27);
